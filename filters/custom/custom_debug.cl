void print_pkmitem(item i) 
{
	switch(i)
	{
		case GrassEnergy : printf("GrassEnergy"); break;
		case FireEnergy : printf("FireEnergy"); break;
		case WaterEnergy : printf("WaterEnergy"); break;
		case ElecEnergy : printf("ElecEnergy"); break;
		case PsyEnergy : printf("PsyEnergy"); break;
		case FightingEnergy : printf("FightingEnergy"); break;
		case NormalEnergy : printf("NormalEnergy"); break;
		case DarkEnergy : printf("DarkEnergy"); break;
		case MetalEnergy : printf("MetalEnergy"); break;
		case FairyEnergy : printf("FairyEnergy"); break;
		case DragonEnergy : printf("DragonEnergy"); break;
		case EarthEnergy : printf("EarthEnergy"); break;

		case Pokeball : printf("Pokeball"); break;
		case GreatBall : printf("GreatBall"); break;
		case MoonStone : printf("MoonStone"); break;
		case SunStone : printf("SunStone"); break;
		case WaterStone : printf("WaterStone"); break;
		case LeafStone : printf("LeafStone"); break;
		case FireStone : printf("FireStone"); break;
		case ThunderStone : printf("ThunderStone"); break;
		case LinkingCord : printf("LinkingCord"); break;
		case LeftOvers : printf("LeftOvers"); break;
		case Leek : printf("Leek"); break;
		case ThickClub : printf("ThickClub"); break;
		case TeraOrb : printf("TeraOrb"); break;
		case MetalCoat : printf("MetalCoat"); break;
		case DragonScale : printf("DragonScale"); break;
		case KingsRock : printf("KingsRock"); break;
		case Upgrade : printf("Upgrade"); break;
		case DubiousDisc : printf("DubiousDisc"); break;
		case IceStone : printf("IceStone"); break;
		...
		case Articuno : printf("Articuno"); break;
		case Zapdos : printf("Zapdos"); break;
		case Moltres : printf("Moltres"); break;
		case Mewtwo : printf("Mewtwo"); break;
		case Mew : printf("Mew"); break;
		case Missingno : printf("Missingno"); break;

		default : printf("Unkown item with id : %d", i); break;
	}
}
